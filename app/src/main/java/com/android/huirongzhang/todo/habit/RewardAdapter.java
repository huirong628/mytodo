...
public class RewardAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.reward_item, viewGroup, false);
            viewHolder.dateView = (TextView) view.findViewById(R.id.reward_date);
            viewHolder.prizeView = (TextView) view.findViewById(R.id.reward_prize);
            viewHolder.valueView = (TextView) view.findViewById(R.id.reward_value);
